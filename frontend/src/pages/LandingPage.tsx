...
import { ArrowRight, BarChart2, ShieldCheck, Zap, BrainCircuit, Activity, Database, Key, Server, Target, Users, PlayCircle, Layers, CheckCircle2, Mail } from "lucide-react";
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-10 mb-16">
            ...
            <div>
              ...
              <ul className="space-y-4 text-sm text-gray-400">
                ...
                <li>
                  <a href="mailto:hariom.yadavse@gmail.com" className="flex items-center gap-2 hover:text-[var(--color-brand-green)] transition-colors">
