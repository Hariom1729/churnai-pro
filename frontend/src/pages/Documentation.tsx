...
export default function Documentation() {
  return (
    <div className="min-h-screen bg-[#020202] text-slate-300">
      {/* Top Bar */}
      <div className="border-b border-white/10 bg-black/50 sticky top-0 z-50 backdrop-blur-md">
        <div className="max-w-4xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <Book className="text-[var(--color-brand-green)]" size={24} />
            <span className="text-xl font-bold text-white">Platform Documentation</span>
          </div>
          <Link to="/" className="text-sm text-slate-400 hover:text-white flex items-center gap-2 transition-colors">
